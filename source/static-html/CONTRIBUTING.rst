...
https://github.com/mattmakai/fullstackjava.com/pulls.
...
https://github.com/mattmakai/fullstackjava.com/issues.
...
**Ready to contribute? Here's how to set up Full Stack Java for local development.**

1. Fork the `fullstackjava.com <https://github.com/mattmakai/fullstackjava.com>`_ repo on GitHub.

2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/fullstackjava.com.git fsj
...
1. To keep your fork in sync with the original repo, add an `upstream remote <https://help.github.com/articles/configuring-a-remote-for-a-fork/>`_::
    ...
    $ git remote add upstream git@github.com:mattmakai/fullstackjava.com.git
